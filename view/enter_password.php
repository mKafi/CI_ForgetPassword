            ...
            <div class="col-md-8 col-sm-10 col-xs-10 col-md-offset-2">
                ...
                <form action="" class="form-horizontal" method="post">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="Notes">New Password</label>
                        <div class="col-sm-10">
                            <input type="password" class="form-control" name="new-pass" required="required" value=""/> 
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="Notes">New Password</label>
                        <div class="col-sm-10">
                            <input type="password" class="form-control" name="re-pass" required="required" value=""/> 
                        </div>
                    </div>
                    <div class="box-footer">
                        <input name="submit" class="btn btn-info pull-right" value="Set Password" type="submit">
                    </div><!-- /.box-footer -->
                </form>
            </div>
            <!-- /.col -->
        ...
        <div class="login-box">
          ...
          <div class="login-box-body">
            ...
            <form action="" class="form-horizontal" method="post">
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        <input type="password" class="form-control" name="new-pass" required="required" value="" placeholder="Enter new password" autocomplete="false"/> 
                    </div>
                </div>

                <div class="form-group">
                    <div class="col-sm-12">
                        <input type="password" class="form-control" name="re-pass" required="required" value="" placeholder="Re-type password" autocomplete="false"/> 
                    </div>
                </div>
                <div class="box-footer">
                    <input name="submit" class="btn btn-info pull-right" value="Set Password" type="submit">
